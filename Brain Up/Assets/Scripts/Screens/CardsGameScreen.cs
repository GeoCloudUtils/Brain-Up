...
{
    public class CardsGameScreen : MonoBehaviour, AbstractScreen
    {
        ...
        private void Start()
        {
            ...
            //InitScreen(testSprites, "Test question. Select card.", testAnswers);
        }
        ...
        public void InitScreen(Sprite[] images, string question, bool[] answers)
        {
            ...
            Debug.Log("CardsGameScreen::InitScreen called! 1; Count: " + count);
            ...
            Debug.Log("CardsGameScreen::InitScreen called! 6");
        }
        ...
        private int OnCheckState(StatesImage img)
        {
            ...
            if (newState == 2)
            {
                ...
                if (currHeartsCount == 0)
                {
                    ...
                    GlobalController.Instance.StopGame(GameEndReason.NoAttempts);
                    return 0;
                }
            }
            else
