...
{
    public class ViewNumbersProduct : SingleInstanceObject<ViewRepeatLetters>,
        ViewAbstract
    {
        [Header("References")]
        ...
        //Properties
        public ModelNumbersProduct Model { get; protected set; }
        private string answer;


        public void Create(ModelNumbersProduct model)
        {
        ...
        {
            Model = (ModelNumbersProduct)model;
        }
        ...
        public ModelNumbersProduct GetModel()
        {
            return Model;
        }
