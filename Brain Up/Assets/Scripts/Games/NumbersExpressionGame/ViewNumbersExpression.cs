...
{
    public class ViewNumbersExpression : SingleInstanceObject<ViewRepeatLetters>,
        ViewAbstract
    {
        [Header("References")]
        ...
        //Properties
        public ModelNumbersExpression Model { get; protected set; }
        private string answer;


        public void Create(ModelNumbersExpression model)
        {
        ...
        public void StartGame(Action endCallback = null)
        {
            ...
            //Set result
            if(Model.CorrectAnswer % 1==0)
                answer = string.Format("{0:0}", Model.CorrectAnswer);
            else
                answer = string.Format("{0:0.0}", Model.CorrectAnswer);
            Debug.Log("Answer: " + answer);
            Debug.Log("Answer rest: " + Model.CorrectAnswer % 1);
            string tmp = "";
        ...
        {
            Model = (ModelNumbersExpression)model;
        }
        ...
        public ModelNumbersExpression GetModel()
        {
            return Model;
        }
